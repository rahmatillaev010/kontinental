...
values
  ...
  ('home_foundation', 'Дата основания гильдии', '17.02.2026', null, 5),
  ('home_discord_link', 'Discord гильдии', 'Укажи здесь ссылку на Discord в админ-панели, чтобы участники быстро переходили в голос и комнаты.', '#', 6),
  ('home_tiktok_link', 'TikTok гильдии', 'Ссылка на TikTok гильдии для роликов, моментов и новостей состава.', '#', 7),
  ('home_leader_contact', 'Связь с лидером', 'Telegram для связи с лидером или руководством Континенталя.', 'https://t.me/glkontinental', 8),
